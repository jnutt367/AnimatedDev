...
gsap.to('h2', { duration: 3, color: "silver", scale: "1", ease: "elastic", textContent: "As you scroll down this page will be transforming with the wonderful powers of GSAP3 animations" });
